...
const props = defineProps(["outflows"]);
const items = ref(props.outflows);
const itemsDisplay = ref(props.outflows);
const searchQuery = ref("");

const columnsExits = ref([
    { key: "id", label: "ID" },
    { key: "exit_date", label: "Fecha de Salida" },
        ...
        <card-data title="Salidas de Materia Prima">
            <template v-slot:filters>
                ...
                >
                    ...
                    <button-add :href="route('outflows.create')"
